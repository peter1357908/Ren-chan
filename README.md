...
1. make a suitable Google Spreadsheet ([example](https://docs.google.com/spreadsheets/d/1EWBqfQw-873ebhF8npP0Njab9dgSlpn8rOGoRSANOIQ)).
    - optionally, make the sheets publicly viewable but disable downloading/copying for non-editors.
